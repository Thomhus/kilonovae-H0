...
ps1.write('/home/thussenot/kilonovae-H0/InjectionBaseLightcurve1_ps1.dat',format='ascii.csv',overwrite=True)
...
mass.write('/home/thussenot/kilonovae-H0/InjectionBaseLightcurve1_mass.dat',format='ascii.csv',overwrite=True)
